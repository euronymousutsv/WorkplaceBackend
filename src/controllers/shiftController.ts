...
//       .status(StatusCode.OK)
//       .json(
//         new ApiResponse(StatusCode.OK, shift, "Shift retrieved successfully")
//       );
//   } catch (error) {
...
//   if (!start || !end) {
//     next(
//       new ApiError(StatusCode.BAD_REQUEST, {}, "Missing date range parameters")
//     );
//     return;
//   }
//   try {
...
//       .status(StatusCode.OK)
//       .json(
//         new ApiResponse(StatusCode.OK, updated[0], "Shift updated successfully")
//       );
//   } catch (error) {
//     if (error instanceof ApiError) {
//       next(error);
...
// // POST /shifts/repeat
// export const createRepeatingShifts = async (
//   req: Request,
//   res: Response,
//   next: NextFunction
// ) => {
...
//           StatusCode.OK,
//           employee,
//           "Employee with availability retrieved successfully"
//         )
//       );
//   } catch (error) {
//     if (error instanceof ApiError) {
...
//           StatusCode.INTERNAL_SERVER_ERROR,
//           {},
//           "Failed to retrieve employee with availability"
//         )
//       );
//     }
//   }
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          clock,
          "Clock in/out record retrieved successfully"
        )
      );
  } catch (error) {
    if (error instanceof ApiError) {
      ...
      next(
        new ApiError(
          StatusCode.INTERNAL_SERVER_ERROR,
          {},
          "Failed to retrieve clock in/out record"
        )
      );
    }
  }
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          records,
          "Clock in/out records retrieved successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to retrieve clock in/out records"
      )
    );
  }
};
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.CREATED,
          record,
          "Clock in/out record created successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to create clock in/out record"
      )
    );
  }
};
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          records[0] || null,
          "Latest clock in/out record retrieved successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to retrieve latest clock in/out record"
      )
    );
  }
};
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          rate,
          "Penalty rate retrieved successfully"
        )
      );
  } catch (error) {
    if (error instanceof ApiError) {
      ...
      next(
        new ApiError(
          StatusCode.INTERNAL_SERVER_ERROR,
          {},
          "Failed to retrieve penalty rate"
        )
      );
    }
  }
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          rates,
          "Penalty rates retrieved successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to retrieve penalty rates"
      )
    );
  }
};
  ...
  try {
    ...
    if (!name || multiplier == null) {
      throw new ApiError(
        ...
        {},
        "Both 'name' and 'multiplier' are required"
      );
    }
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.CREATED,
          rate,
          "Penalty rate created successfully"
        )
      );
  } catch (error) {
    if (error instanceof ApiError) {
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          timeOff,
          "Time off record retrieved successfully"
        )
      );
  } catch (error) {
    if (error instanceof ApiError) {
      ...
      next(
        new ApiError(
          StatusCode.INTERNAL_SERVER_ERROR,
          {},
          "Failed to retrieve time off record"
        )
      );
    }
  }
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          records,
          "Time off records retrieved successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to retrieve time off records"
      )
    );
  }
};
  ...
  try {
    ...
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to create time off record"
      )
    );
  }
};
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          rows[0],
          "Time off record updated successfully"
        )
      );
  } catch (error) {
    if (error instanceof ApiError) {
      ...
      next(
        new ApiError(
          StatusCode.INTERNAL_SERVER_ERROR,
          {},
          "Failed to update time off record"
        )
      );
    }
  }
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          request,
          "Shift request retrieved successfully"
        )
      );
  } catch (error) {
    if (error instanceof ApiError) {
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          records,
          "Shift requests retrieved successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to retrieve shift requests"
      )
    );
  }
};
    ...
    res
      ...
      .json(
        new ApiResponse(
          StatusCode.OK,
          records,
          "Pending shift requests retrieved successfully"
        )
      );
  } catch (error) {
    next(
      new ApiError(
        StatusCode.INTERNAL_SERVER_ERROR,
        {},
        "Failed to retrieve pending shift requests"
      )
    );
  }
};
    ...
    if (error instanceof ApiError) {
      ...
      next(
        new ApiError(
          StatusCode.INTERNAL_SERVER_ERROR,
          {},
          "Failed to update shift request"
        )
      );
    }
  }
