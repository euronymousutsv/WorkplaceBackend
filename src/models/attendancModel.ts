...
interface AttendanceEventCreationAttributes extends Optional<AttendanceEventAttributes, 'id'|"clockStatus"|"eventDate"|"eventTime"|"employeeId"> {}

class AttendanceEvent extends Model <AttendanceEventAttributes,AttendanceEventCreationAttributes> implements AttendanceEventAttributes {
  public id!: string;
